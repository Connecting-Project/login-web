...
function Login() {
    ...
    const onNaverLoginHandler = (naveruser) => {
        sessionStorageCustom.setJsonItem('user', {
            type: 'naver',
            id: naveruser.id,
            email: naveruser.email,
            name: naveruser.name,
            profile_image: naveruser.profile_image === "string" ? naveruser.profile_image : 'https://martialartsplusinc.com/wp-content/uploads/2017/04/default-image.jpg',
        });
        setLoginState(true);
        history.push(`/loginresult`);
    }
